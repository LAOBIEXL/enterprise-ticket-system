...
public record UserAdminQuery(
        ...
        @Positive(message = "部门 ID 必须大于 0") Long departmentId,
    ...
    public int normalizedPageNum() { return pageNum == null ? 1 : pageNum; }

    @Parameter(hidden = true)
    public int normalizedPageSize() { return pageSize == null ? 10 : pageSize; }
